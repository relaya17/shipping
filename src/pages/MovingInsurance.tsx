    ...
    <Container className="my-5">
      ...
      <Row className="text-center mb-5">
        <Col>
          ...
          <Badge bg="success" className="me-2">רישיון Lloyd's of London</Badge>
          <Badge bg="primary">כיסוי עד $100,000</Badge>
        </Col>
      </Row>
            ...
            <Card.Body>
              <Form>
                <Form.Group className="mb-3">
                  <Form.Label>ערך החפצים (USD)</Form.Label>
                  <Form.Control
                    type="number"
                    value={itemValue}
                ...
                <Form.Group className="mb-3">
                  <Form.Label>בחר תוכנית ביטוח</Form.Label>
                  <Form.Select
                    value={selectedPlan}
                ...
                <Button variant="primary" className="w-100" disabled={!selectedPlan || !itemValue}>
                  קבל הצעת ביטוח
                </Button>
              </Form>
            </Card.Body>
              ...
              <Row>
                <Col md={6} className="mb-3">
                  ...
                  <ul className="list-unstyled">
                    <li><CheckCircle size={16} className="text-success me-2" />נזקים פיזיים במהלך ההובלה</li>
                    <li><CheckCircle size={16} className="text-success me-2" />גניבה או אובדן</li>
                    <li><CheckCircle size={16} className="text-success me-2" />נזקי מים ואש</li>
                    <li><CheckCircle size={16} className="text-success me-2" />תאונות תחבורה</li>
                    <li><CheckCircle size={16} className="text-success me-2" />נזקים בזמן טעינה/פריקה</li>
                  </ul>
                </Col>
                <Col md={6} className="mb-3">
                  <h6 className="text-danger">לא מכוסה:</h6>
                  <ul className="list-unstyled">
                    <li><ExclamationTriangle size={16} className="text-warning me-2" />בלאי טבעי</li>
                    <li><ExclamationTriangle size={16} className="text-warning me-2" />נזקים קיימים</li>
                    <li><ExclamationTriangle size={16} className="text-warning me-2" />אריזה לא נאותה</li>
                    <li><ExclamationTriangle size={16} className="text-warning me-2" />נזקי חרקים או מכרסמים</li>
                    <li><ExclamationTriangle size={16} className="text-warning me-2" />פריטים אסורים לשילוח</li>
                  </ul>
                </Col>
              </Row>
            </Card.Body>
